...
import {indecent, incdecinput, indevout  } from '../globals/style';
                ...
                <View style={styles.s2}>
                    ...
                    {data.foodAddonPrice != "" && <View style={styles.container3}>
                        ...
                        <View style={indevout}>
                            ...
                            <Text onPress={() => increaseAddonQuantity()} style={indecent}>+</Text>
                            <TextInput value={addonquantity} style={incdecinput} />
                            <Text onPress={() => decreaseAddonQuantity()} style={indecent}>-</Text>
                    ...
                    <View style={styles.container3}>
                        ...
                        <View style={indevout}>
                            ...
                            <Text onPress={() => increaseQuantity()} style={indecent}>+</Text>
                            <TextInput value={quantity} style={incdecinput} />
                            <Text onPress={() => decreaseQuantity()} style={indecent}>-</Text>
